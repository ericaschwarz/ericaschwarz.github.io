...
There are significant opportunities in extending the capabilities of cell-to-tissue simulation coupling to consider the direct impact of mechanosensitivity and exogenous factors on cellular gene expression. This research will lead to additional capability to recommend pharmacological interventions based on patient-specific geometries and hemodynamics and, eventually, biomarkers that indicate patient-specific gains in resulting cell-signaling networks. In addition to clinical predictions, this will provide the ability to create synthetic datasets to aid in large-data models. Creating synthetic datasets that can mimic in vivo behaviors of interest has the potential to greatly lower the cost of transfering these models to the clinical setting. In parallel, this research will have the potential to create strong collaborations in medical uncertainty quantification and fundamental studies of cardiovascular biology. Initial stages of this future work will focus on particular applications in congenital heart defects, engineered graft development, and aneurysm prediction.
